...
public class Recipe2P9HandlingExceptionInAsyncVoid
{
    ...
    /// ///
    /// <seealso
    ///     href="https://devblogs.microsoft.com/dotnet/how-async-await-really-works/#synchronizationcontext-and-configureawait">
    ...
    {
        public int NumberOfStartedOperations { get; private set; }
        public int NumberOfCompletedOperations { get; private set; }
